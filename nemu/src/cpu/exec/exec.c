...
opcode_entry opcode_table [512] = {
  ...
  /* 0x50 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(r,push), IDEX(r,push),IDEX(r,push),IDEX(r,push),
  /* 0x54 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(r,push), IDEX(r,push),IDEX(r,push),IDEX(r,push),
  /* 0x58 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(r,pop), IDEX(r,pop),IDEX(r,pop),IDEX(r,pop),
  /* 0x5c */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(r,pop), IDEX(r,pop),IDEX(r,pop),IDEX(r,pop),
  ...
  /* 0xe8 */	IDEX(J, call), EMPTY, EMPTY, EMPTY,//等待实现：添加其他call
