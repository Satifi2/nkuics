...
opcode_entry opcode_table [512] = {
  ...
  /* 0x0c */	EMPTY, EMPTY, EMPTY, EX(2byte_esc),//对应0d,表示2字节
  ...
  /* 0xb8 */	EMPTY, EMPTY, IDEXW(E2G, movzx, 1), IDEXW(E2G, movzx, 2),
  /* 0xbc */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xc0 */	EMPTY, EMPTY, IDEXW(E2G, movsx, 1), IDEXW(E2G, movsx, 2),
