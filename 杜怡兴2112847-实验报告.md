...
上述实验不仅仅证明了当前系统确实是小端序,而且还说明了需要小端序来实现寄存器union当中\_16是\_32的低16位，而\_8[0]是\_16低8位，\_8[1]是\_16的高8位的效果.
...
首先这一段检查已经全部通过，这是因为通过union共享空间，sample[0]和gpr[0].共享同一个空间,而通过
![image-20240310184217368](C:\Users\86157\AppData\Roaming\Typora\typora-user-images\image-20240310184217368.png)
